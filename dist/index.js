...
__export(index_exports, {
  ...
  Structure: () => Structure,
  TTLCache: () => TTLCache,
  buildAutoplaySeed: () => buildAutoplaySeed,
  buildSearchIdentifier: () => buildSearchIdentifier,
...
var Moodenglink = class extends import_node_events.EventEmitter {
  constructor(options) {
    ...
    this.players = new import_collection.Collection();
    this.plugins = new import_collection.Collection();
